...
local util = require("user.heirl.util")
local icons = util.icons
local mode = util.mode
-- local hydra = prequire("hydra.statusline")

-- local theme, theme_available = require("user/heirl/gruvbox-material" .. (vim.g.colors_name or ""))
local theme_available, theme = true, require("user/heirl/gruvbox-material")
